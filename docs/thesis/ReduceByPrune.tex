...
\begin{algorithm}[H]
  ...
  \begin{algorithmic}[1]
    ...
    \If{$G_{\min},G_{\max},e_i$に$operator$が適応できる}
...
\begin{figure}
  ...
  \hspace{-5mm}
  \subfloat[igraphライブラリ,Erdos-R{\'e}nyiモデル]{
  ...
  \hspace{-5mm}
  \subfloat[提案手法,Erdos-R{\'e}nyiモデル]{
...
枝刈りの高速化について考察する．図\ref{fig:sinitr-time-by-state-d3}より，
...
保持するデータが増加したこと(グラフ1個と$n\times n$行列が4個)によって，
