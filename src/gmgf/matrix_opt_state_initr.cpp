...
#include "matrix_opt_state_initr.hpp"
#include "matrix_opt_state.hpp"
#include "distance_update.hpp"

namespace gmgf {

  state* matrix_opt_state_initr::initial(graph_initr* ginitr) {
    ...
    return new matrix_opt_state(config, G, d_min, d_max, s_max,
                                igraph_matrix_max(&d_max));
  }
